      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex justify-center">
          <a
            ...
            className="flex items-center gap-3 px-8 py-4 bg-[#25D366] text-white font-semibold rounded-lg hover:bg-[#20BA5A] transition-colors shadow-lg hover:shadow-xl text-lg"
          >
            <svg
              width="28"
              height="28"
